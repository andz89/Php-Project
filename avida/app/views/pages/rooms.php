        ...
        <?php foreach ($data['rooms'] as  $rooms) : ?>
          <div class="mt-3 shadow-md">
            ...
            <div class="card  py-3 room-a d-flex flex-row">
              ...
              <div class="card-body ">
                <a href="<?php echo URLROOT; ?>/pages/room?id=<?php echo $rooms->id ?>" style=" text-decoration:none;">
                  <h4 class=" text-left"><?php echo $rooms->room_name ?></h4>
                </a>
                <span class=" text-left">
                  <div>

                    <h6> <small> Booking Fee: </small> <b> <?php echo $rooms->room_amount ?></b> pesos</h6>
                  </div>
