      ...
      <div class="list-group-item  flex-column align-items-start  my-2">
        ...
        <div class="collapse" id="<?php echo $booking->id ?>">
          ...
          <div class="card bg-info text-white">
            <div class="card-body">
              Payment Receipt:<br>
              <span>Payment ID: </span> <span> <b> <?php echo $booking->room_name ?>-<?php echo $booking->booking_id ?></b></span>
              <br>
              <span>Amount: </span> <span> <b><?php echo $booking->booking_fee ?></b></span> pesos
              <br>
              <span>Date of payment: </span> <span> <b><?php echo $booking->created_at  ?></b></span>
