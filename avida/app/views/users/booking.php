    ...
    <?php foreach ($data['booking'] as  $bookings) : ?>
      ...
      <li class="list-group-item my-2">
        ...
        <div class="card bg-info text-white">
          <div class="card-body">
            Payment Receipt:<br>
            <span>Payment ID: </span> <span> <b> <?php echo $bookings->room_name ?>-<?php echo $bookings->booking_id ?></b></span>
            <br>
            <span>Amount: </span> <span> <b><?php echo $bookings->booking_fee ?></b></span> pesos
            <br>
            <span>Date of payment: </span> <span> <b><?php echo $bookings->created_at  ?></b></span>
